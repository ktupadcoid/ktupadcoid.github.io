...
<div class="kiri" ><span class="">ktupad</span><span class="orange">.co.id</span></div> \
<div class="kanan" ></div> \
</div> \
...
'<span class="judul">Selamat Datang di ktupad.co.id</span><br> \
...
atau email ke konfirmasi@ktupad.co.id<br> \
...
atau email ke sales@ktupad.co.id <br>\
dengan menyertakan nama pemilik rekening, email dan nama paket.<br>\
Kode aktifasi dikirim melalui email setelah kami terima pembayaran.',
'\
